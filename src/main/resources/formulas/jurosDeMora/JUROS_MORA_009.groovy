...
//dataInicioCobranca = DATA_ADICIONAR(lancamento.dataVencimento, 1, "D")
dataInicioCobranca = lancamento.dataVencimento
...
indiceAcumulado = MAXIMO(DATADIF(dataInicioCobranca, dataFinalCobranca, "M"), 0.00) * 0.005
