 ...
 *
 * Item 5.7, alíneas "a" e "b", do Edital de Licitação nº 2/2015-SOR/SPR/CD-ANATEL
 * Variação do IGP-DI, desde a data da entrega dos Documentos de Identificação e de Regularidade Fiscal, das Propostas de Preço e da
 * Documentação de Habilitação até a data do efetivo pagamento. Caso o pagamento ocorra após 12 (doze) meses da data de entrega desses
 * documentos, além da atualização pelo IGP-DI, os valores são acrescidos de juros simples de 1% (um por cento) ao mês, incidentes sobre
 * o valor corrigido, desde a data de publicação, no Diário Oficial da União, do extrato do Termo de Autorização
 **********************************************************************************************************/
