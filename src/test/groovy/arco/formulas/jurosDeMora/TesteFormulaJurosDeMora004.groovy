...
class TesteFormulaJurosDeMora004 extends Specification {
    ...
    def "Teste de calculo de juros de mora"() {
        ...
        where:
        valor_original | valor_pago | data_vencimento | data_competencia | data_pagamento | houve_suspencao_exibilidade | data_constituicao | data_atual     | indice_juros || indice_aplicado | mes_inicio_juros | mes_final_juros | juros_mora | valor_total
        1000.00        | 0.00       | "01/06/2016"    | "17/05/2012"     | null           | true                        | null              | "01/05/2016"   | 0.00         || null            | null             | null            | 0.00       | 1000.00
