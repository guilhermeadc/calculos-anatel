 ...
 */
class TesteFormulaJurosDeMora008 extends Specification {

    def script = "JUROS_MORA_008.groovy"
    ...
    def "Teste de calculo de juros de mora"() {
        ...
        parametros["DATA_CONDENACAO_PRIMEIRA_INSTANCIA"] = data_condenacao ? Date.parse("d/MM/yyyy", data_condenacao) : null
        ...
        where:
        valor_original | data_condenacao | data_pagamento | data_atual     | indice_juros || indice_aplicado | mes_inicio_juros | mes_final_juros | juros_mora | valor_total
