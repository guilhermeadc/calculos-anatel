 ...
 */
class TesteFormulaMultaDeMora033Limite10ou20 extends Specification {

    def script = "formula_multa_mora_033_limite_10_ou_20.groovy"
    ...
    def "Teste de calculo de multa de mora"() {
        ...
        1000.00        | "01/06/2007"    | "01/05/2007" || 0          | 1000.00      //Data atual inferior ao dia de vencimento (0 dias de atraso)
        1000.00        | "01/06/2007"    | "01/06/2007" || 0          | 1000.00      //Data atual igual ao dia de vencimento (0 dias de atraso)
        1000.00        | "01/06/2007"    | "02/06/2007" || 3.30       | 1003.30      //Data atual posterior a data de vencimento (1 dias de atraso)
        1000.00        | "01/06/2007"    | "01/07/2007" || 99.00      | 1099.00      //Data atual 1 mês posterior a data de vencimento (30 dias de atraso)
        1000.00        | "01/06/2006"    | "01/01/2007" || 100.00     | 1100.00      //Data atual 6 mês posterior a data de vencimento. Multa limitada à 20%
    }
