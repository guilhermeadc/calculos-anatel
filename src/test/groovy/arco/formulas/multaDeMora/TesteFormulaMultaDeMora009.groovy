 ...
 */
class TesteFormulaMultaDeMora009 extends Specification {

    def script = "MULTA_MORA_009.groovy"
    ...
    def "Teste de calculo de multa de mora"() {
        ...
        where:
        valor_original | data_comunicado | data_pagamento | data_atual   || multa_mora | valor_total
    ...
    def "Teste de calculo de multa de morasem informação da data de recebimento do comunicado de mudança"() {
        when: "Quando a fórmula é executada com lancamento sem data de entrega da documentação"
        calculadora.executarFormula(script, lancamento, ["DATA_RECEBIMENTO_COMUNICADO_COBRANCA": null])
