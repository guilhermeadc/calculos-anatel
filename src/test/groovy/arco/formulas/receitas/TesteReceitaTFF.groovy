...
class TesteReceitaTFF extends Specification {
    ...
    def "Teste de calculo TFF"() {
        ...
        where:
        valor_original | data_vencimento | data_atual   | indice_juros | indice_multa || atualizacao | multa_oficio | juros_mora | multa_mora | valor_total
        "1000.00"      | "01/06/2016"    | "01/05/2016" | 0.00         | 0.00         || 0           | 0            | 0          | 0          | 1000.00
        "1000.00"      | "01/06/2016"    | "01/06/2016" | 0.00         | 0.00         || 0           | 0            | 0          | 0          | 1000.00
        "1000.00"      | "01/06/2016"    | "02/06/2016" | 0.00         | 0.00         || 0           | 0            | 0          | 3.30       | 1003.30
        "1000.00"      | "01/06/2016"    | "01/07/2016" | 0.01         | 0.00         || 0           | 0            | 10.00      | 99.00      | 1109.00
        "1000.00"      | "01/06/2015"    | "01/01/2016" | 0.06         | 0.00         || 0           | 0            | 60.00      | 200.00     | 1260.00
    }
}
